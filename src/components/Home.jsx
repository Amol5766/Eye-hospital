...
<div className="min-h-screen flex flex-col lg:flex-row justify-between items-center lg:px-32 px-5 pt-24 lg:pt-16 gap-5 bg-orange-500 relative overflow-hidden">
  <div className="w-full lg:w-3/4 space-y-6 relative">
    ...
    <hr className="border-white my-1 relative flex flex-col lg:flex-row" />
    <a href="/about" className=" relative inline-block mt-6 bg-white text-black py-4 px-6 rounded-full hover:bg-gray-200 transition-color z-10">
  ...
  <img className="absolute top-1/7 left-1/2 transform -translate-x-1/4 -translate-y-1/2 w-full lg:w-4/5 rounded-lg mb-4 lg:mb-0" src={imgOverlay} alt="About Us" />
...
<div className="my-16">
  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-10 lg:mb-0">
    <div className="text-center lg:text-center mb-4 lg:mb-0">
      <h1 className="text-4xl font-semibold">
        Know More About Eye Diseases
      </h1>
      <p className="mt-2 lg:translate-x-[+130px] mb-6">
