...
const EyeDiseases = () => {
  const data = [
    {
      img: "/src/assets/img/disease1.jpg",
      name: "Disease 1",
      description: "Description of Eye Disease 1.",
    },
    {
      img: "/src/assets/img/disease2.jpg",
      name: "Disease 2",
      description: "Description of Eye Disease 2.",
    },
    {
      img: "/src/assets/img/disease3.jpg",
      name: "Disease 3",
      description: "Description of Eye Disease 3.",
    },
    {
      img: "/src/assets/img/disease4.jpg",
      name: "Disease 4",
      description: "Description of Eye Disease 4.",
    },
    {
      img: "/src/assets/img/disease5.jpg",
      name: "Disease 5",
      description: "Description of Eye Disease 5.",
    },
    {
      img: "/src/assets/img/disease6.jpg",
      name: "Disease 6",
      description: "Description of Eye Disease 6.",
    },
  ];
  ...
  return (
    <div className="relative min-h-screen flex flex-col justify-center lg:px-32 px-5 pt-16">
      <div className="mb-4 text-gray-500">
        <p className="text-sm">
          <a href="/">Home</a>  &gt; <span className="text-gray-700">Diseases</span>
        </p>
      </div>
