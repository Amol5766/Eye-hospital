        ...
        <div className="flex flex-row justify-between p-1 md:px-32 px-5 bg-backgroundColor shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
          ...
          <div className="flex flex-row items-center gap-8">
            <nav className="hidden lg:flex flex-row items-center text-lg font-medium gap-8">
              ...
              <Link to="/aboutus" className="hover:text-hoverColor transition-all cursor-pointer">
                About Us
              </Link>
              ...
              <Link to="/contact" className="hover:text-hoverColor transition-all cursor-pointer">
                Contact
              </Link>
            </nav>
            </div>
